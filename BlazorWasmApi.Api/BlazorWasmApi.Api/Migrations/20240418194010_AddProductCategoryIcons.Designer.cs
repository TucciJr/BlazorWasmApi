...
namespace BlazorWasmApi.Api.Migrations
{
    ...
    [Migration("20240418194010_AddProductCategoryIcons")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlazorWasmApi.Api.Entities.Cart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorWasmApi.Api.Entities.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorWasmApi.Api.Entities.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorWasmApi.Api.Entities.ProductCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorWasmApi.Api.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorWasmApi.Api.Entities.Cart", b =>
                {
                    b.HasOne("BlazorWasmApi.Api.Entities.User", "User")
                        .WithMany("Carts")
            ...
            modelBuilder.Entity("BlazorWasmApi.Api.Entities.CartItem", b =>
                {
                    b.HasOne("BlazorWasmApi.Api.Entities.Cart", "Cart")
                        .WithMany("CartItems")
                        .HasForeignKey("CartId")
                        .IsRequired()
                        .HasConstraintName("FK_CartItems_Carts");

                    b.HasOne("BlazorWasmApi.Api.Entities.Product", "Product")
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("BlazorWasmApi.Api.Entities.Product", b =>
                {
                    b.HasOne("BlazorWasmApi.Api.Entities.ProductCategory", "Category")
                        .WithMany("Products")
